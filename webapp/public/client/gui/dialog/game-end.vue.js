    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header" :style="area_background(winner)">
          <div :class="'d-inline-block flag flag-sm border border-dark rounded flag-'+winner"></div>
            ...
            <table class="table table-borderless table-hover table-sm">
              <tbody>
                <tr v-for="(country, iso) in countries" :class="{'bg-secondary': winner == iso}">
                  <td><div :class="'flag flag-xs pointer border border-dark rounded flag-'+iso"></div></td>
